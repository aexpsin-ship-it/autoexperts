    ...
    <section className="bg-[#111111] py-20 text-white">
      <div className="container mx-auto grid items-center gap-14 px-4 lg:grid-cols-2 lg:px-10">
        ...
        >
          ...
          <div className="absolute -bottom-8 right-6 rounded-3xl border border-white/10 bg-black/80 px-8 py-6 backdrop-blur-xl">
            <h4 className="text-4xl font-bold text-[#c7a66b]">15+</h4>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <span className="mb-4 inline-block rounded-full border border-[#c7a66b]/30 bg-[#c7a66b]/10 px-5 py-2 text-sm uppercase tracking-[3px] text-[#c7a66b]">
            Premium Workshop
          </span>
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            {services.map((service, index) => (
              <div
                key={index}
                className="flex items-center gap-4 rounded-2xl border border-white/10 bg-white/[0.03] p-5 transition-all duration-300 hover:border-[#c7a66b]/40"
              >
                <div className="text-[#c7a66b]">{service.icon}</div>
